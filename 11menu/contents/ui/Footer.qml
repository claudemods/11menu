...
RowLayout{
    ...
    PlasmaComponents3.ToolButton {
        ...
        onClicked: {
            ...
            logic.openUrl("file://" + home + "/.local/share/plasma/plasmoids/adhe.menu.11/contents/ui/logout.desktop");
        }
        ToolTip.delay: 1000
        ToolTip.timeout: 1000
        ToolTip.visible: hovered
    ...
    PlasmaComponents3.ToolButton {
        ...
        onClicked: {
            const home = String(Qt.resolvedUrl(".")).match(/file:\/\/(.*?)\/.local/)[1];
            logic.openUrl("file://" + home + "/.local/share/plasma/plasmoids/adhe.menu.11/contents/ui/poweroptions.desktop");
        }
